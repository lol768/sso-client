...
public class LinkGenerator {
    ...
    public static final Logger LOGGER = LoggerFactory.getLogger(LinkGenerator.class);
    ...
    public LinkGenerator(SSOConfiguration config, HttpRequest request) {
     ...
     * page to login again.
     */
    public final String getPermissionDeniedLink(User user) {
        if (user.isFoundUser()) {
